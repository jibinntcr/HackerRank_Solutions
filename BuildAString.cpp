...
// Arrays and variables for suffix array construction and LCP computation
int p[17][30010], logg[30010], pas[30010];
int poz[30010], st[30010], dr[30010], rmq[17][30010], n, sol;
char sir[30010];

// Function to compute Longest Common Prefix (LCP) between two suffixes
int LCP(int x, int y) {
    int rez = 0;
...
// Function to perform a query in the segment tree
...
// Function to get the minimum value between two indices in the original array
...
int main() {
    ...
    for (scanf("%d", &t); t; t--) {
        ...
        // Preprocessing for suffix array and LCP array
        ...
        // Dynamic programming to find the length of the longest common prefix for each suffix
        for (int i = 1; i <= n; i++) {
        ...
        // Initialize and update the segment tree for dynamic programming
        arbint_init(1, 1, n);
